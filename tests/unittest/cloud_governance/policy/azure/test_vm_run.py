...
from cloud_governance.policy.azure.cleanup.vm_run import VmRun
from tests.unittest.mocks.azure.mock_compute import MockVirtualMachine, MockAzure


def test_vm_run():
    """
    This method tests vm_run
    :return:
    :rtype:
    """
...
def test_vm_run_stop_false():
    ...
    environment_variables.environment_variables_dict['policy'] = 'vm_run'
...
def test_vm_run_stopped_skip():
    """
    This method tests vm_run skip
    :return:
    :rtype:
    """
    environment_variables.environment_variables_dict['DAYS_TO_TAKE_ACTION'] = 0
...
def test_vm_run_stopped_test_days():
    """
    This method tests vm_run skip
    :return:
    :rtype:
...
def test_vm_run_stopped_test_current_day():
    """
    This method tests vm_run skip
    :return:
    :rtype:
...
def test_vm_run_vm_already_stopped():
    """
